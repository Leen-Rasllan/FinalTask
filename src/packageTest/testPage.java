...
public class testPage extends prameterPage {
	...
	public void  creatAcount()  {
		...
		WebElement Theemail = driver.findElement(By.id (signInMail));
		WebElement Thepasword = driver.findElement(By.id(signInpass));
